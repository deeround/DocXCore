...
namespace Novacode
{
	public class Header : Container, IParagraphContainer
	{
		...
		public bool PageNumbers
		{
			...
			set
			{
				XElement xElement = XElement.Parse("<w:sdt xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>\r\n                    <w:sdtPr>\r\n                      <w:id w:val='157571950' />\r\n                      <w:docPartObj>\r\n                        <w:docPartGallery w:val='Page Numbers (Top of Page)' />\r\n                        <w:docPartUnique />\r\n                      </w:docPartObj>\r\n                    </w:sdtPr>\r\n                    <w:sdtContent>\r\n                      <w:p w:rsidR='008D2BFB' w:rsidRDefault='008D2BFB'>\r\n                        <w:pPr>\r\n                          <w:pStyle w:val='Header' />\r\n                          <w:jc w:val='center' />\r\n                        </w:pPr>\r\n                        <w:fldSimple w:instr=' PAGE \\* MERGEFORMAT'>\r\n                          <w:r>\r\n                            <w:rPr>\r\n                              <w:noProof />\r\n                            </w:rPr>\r\n                            <w:t>1</w:t>\r\n                          </w:r>\r\n                        </w:fldSimple>\r\n                      </w:p>\r\n                    </w:sdtContent>\r\n                  </w:sdt>");
				base.Xml.AddFirst(xElement);
				PageNumberParagraph = new Paragraph(base.Document, xElement.Descendants(XName.Get("p", DocX.w.NamespaceName)).SingleOrDefault(), 0);
			}
		}
		...
		public List<Image> Images
		{
			get
			{
				...
				if (((IEnumerable<PackageRelationship>)relationshipsByType).Count() > 0)
				{
					return (from i in (IEnumerable<PackageRelationship>)relationshipsByType
					select new Image(base.Document, i)).ToList();
				}
